...
R1_airlines.to_csv(outpath1 + path2, index=False)
R2_sairports.to_csv(outpath1 + path3, index=False)
R3_dairports.to_csv(outpath1 + path4, index=False)

R1_airlines.to_csv(outpath2 + path2, index=False)
R2_sairports.to_csv(outpath2 + path3, index=False)
R3_dairports.to_csv(outpath2 + path4, index=False)
