...
parser.add_argument(
    ...
    "-m",
    type=str,
    default="wine_quality_t100_d10_l386_n772_20250321150624"
)
...
def predict(fixed_acidity, volatile_acidity, citric_acid, chlorides, total_sulfur_dioxide, density, sulphates, alcohol):
