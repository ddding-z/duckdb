...
parser.add_argument(
    ...
    "-w",
    type=str,
    default="medical_charges",
)
parser.add_argument(
    "--model",
    "-m",
    type=str,
    default="medical_charges_t100_d10_l903_n1806_20250321150630",
)
...
def predict(Total_Discharges, Average_Covered_Charges, Average_Medicare_Payments):
