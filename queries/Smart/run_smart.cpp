...
std::string LOAD_PATH = "/volumn/Retree_exp/queries/Smart/common/";
std::string SQL_PATH = "/volumn/Retree_exp/queries/Smart/workloads/";
...
void run(const Config &config)
{
    ...
    outputfile << config.workload << "," << config.model << "," << config.model_type << "," << "" << "," << config.scale << ","
               << config.thread << "," << config.optimization_level << "," << average << "\n";
    std::cout << config.workload << "," << config.model << "," << config.model_type << "," << "" << "," << config.scale << ","
              << config.thread << "," << config.optimization_level << "," << average << "\n";
